...
| --- | --- |
| Core idea | Fast Slow Pointers helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Fast Slow Pointers"]
    D --> E["Apply template"]
...
| Hard | Combine Fast Slow Pointers with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Fast Slow Pointers." |
