...
| --- | --- |
| Core idea | Dynamic Programming helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Dynamic Programming"]
    D --> E["Apply template"]
...
| Hard | Combine Dynamic Programming with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Dynamic Programming." |
