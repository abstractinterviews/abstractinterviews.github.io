...
| --- | --- |
| Core idea | Topological Sort helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Topological Sort"]
    D --> E["Apply template"]
...
| Hard | Combine Topological Sort with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Topological Sort." |
