...
| --- | --- |
| Core idea | 2D DP helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
| Hard | Combine 2D DP with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use 2D DP." |
