...
| --- | --- |
| Core idea | Graph Algorithms helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Graph Algorithms"]
    D --> E["Apply template"]
...
| Hard | Combine Graph Algorithms with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Graph Algorithms." |
