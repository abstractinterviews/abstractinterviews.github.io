...
| --- | --- |
| Core idea | Divide and Conquer helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Divide and Conquer"]
    D --> E["Apply template"]
...
| Hard | Combine Divide and Conquer with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Divide and Conquer." |
