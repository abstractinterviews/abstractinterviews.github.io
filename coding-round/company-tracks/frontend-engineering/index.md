...
| --- | --- |
| Core idea | Frontend Engineering helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Frontend Engineering"]
    D --> E["Apply template"]
...
| Hard | Combine Frontend Engineering with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Frontend Engineering." |
