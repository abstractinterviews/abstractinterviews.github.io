...
| --- | --- |
| Core idea | Backend Engineering helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Backend Engineering"]
    D --> E["Apply template"]
...
| Hard | Combine Backend Engineering with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Backend Engineering." |
