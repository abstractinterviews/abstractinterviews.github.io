...
subtitle: "Communicating Tradeoffs for coding interviews: recognition, template, mistakes, and practice."
...
Communicating Tradeoffs is a coding interview topic used to turn a broad problem into a recognizable structure with a clear invariant, implementation template, and complexity story.

## When To Use It?

Use Communicating Tradeoffs when the input constraints or desired optimization match its recognition signals. In interviews, say why the topic fits before writing code.
...
flowchart TD
    ...
    Pain --> Pattern["Apply Communicating Tradeoffs"]
...
def solve(input_data):
    ...
    # Maintain the invariant for Communicating Tradeoffs.
