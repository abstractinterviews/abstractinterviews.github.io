...
| --- | --- |
| Core idea | How To Approach Problems helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize How To Approach Problems"]
    D --> E["Apply template"]
...
| Hard | Combine How To Approach Problems with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use How To Approach Problems." |
