...
| --- | --- |
| Core idea | Optimization Process helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Optimization Process"]
    D --> E["Apply template"]
...
| Hard | Combine Optimization Process with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Optimization Process." |
