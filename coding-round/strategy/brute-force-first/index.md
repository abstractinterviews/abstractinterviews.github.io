...
| --- | --- |
| Core idea | Brute Force First helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Brute Force First"]
    D --> E["Apply template"]
...
| Hard | Combine Brute Force First with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Brute Force First." |
