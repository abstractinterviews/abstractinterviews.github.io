...
| --- | --- |
| Core idea | Thinking Out Loud helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Thinking Out Loud"]
    D --> E["Apply template"]
...
| Hard | Combine Thinking Out Loud with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Thinking Out Loud." |
