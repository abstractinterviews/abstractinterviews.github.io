...
| --- | --- |
| Core idea | Post Mock Review helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Post Mock Review"]
    D --> E["Apply template"]
...
| Hard | Combine Post Mock Review with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Post Mock Review." |
