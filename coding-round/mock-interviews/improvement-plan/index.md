...
| --- | --- |
| Core idea | Improvement Plan helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Improvement Plan"]
    D --> E["Apply template"]
...
| Hard | Combine Improvement Plan with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Improvement Plan." |
