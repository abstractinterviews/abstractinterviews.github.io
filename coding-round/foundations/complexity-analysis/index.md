...
| --- | --- |
| Core idea | Complexity Analysis helps candidates solve coding interviews by recognizing structure, choosing the right tool, and explaining correctness. |
...
flowchart LR
    ...
    C --> D["Recognize Complexity Analysis"]
    D --> E["Apply template"]
...
| Hard | Combine Complexity Analysis with another pattern or data structure. |
...
| Optimize | "The repeated work is..., so I can use Complexity Analysis." |
