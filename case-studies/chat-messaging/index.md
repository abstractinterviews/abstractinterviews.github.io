...
| --- | --- |
| Core idea | Chat / Messaging System helps candidates discuss requirements discovery, API and data modeling, bottleneck analysis, and trade-off defense with clarity. |
...
- Define Chat / Messaging System in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Chat / Messaging System"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Chat / Messaging System"]
...
| --- | --- |
| Problem first | Explain what problem Chat / Messaging System solves before naming tools or patterns. |
...
| Scenario | How Chat / Messaging System Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Chat / Messaging System solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Chat / Messaging System to an interviewer in 90 seconds.
