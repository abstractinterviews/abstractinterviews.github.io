...
| --- | --- |
| Core idea | Design URL Shortener helps candidates discuss requirements discovery, API and data modeling, bottleneck analysis, and trade-off defense with clarity. |
...
- Define Design URL Shortener in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Design URL Shortener"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Design URL Shortener"]
...
| --- | --- |
| Problem first | Explain what problem Design URL Shortener solves before naming tools or patterns. |
...
| Scenario | How Design URL Shortener Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Design URL Shortener solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Design URL Shortener to an interviewer in 90 seconds.
