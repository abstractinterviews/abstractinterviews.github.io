...
| --- | --- |
| Core idea | News Feed System helps candidates discuss requirements discovery, API and data modeling, bottleneck analysis, and trade-off defense with clarity. |
...
- Define News Feed System in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define News Feed System"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["News Feed System"]
...
| --- | --- |
| Problem first | Explain what problem News Feed System solves before naming tools or patterns. |
...
| Scenario | How News Feed System Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does News Feed System solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain News Feed System to an interviewer in 90 seconds.
