...
| --- | --- |
| Core idea | Notification Service helps candidates discuss requirements discovery, API and data modeling, bottleneck analysis, and trade-off defense with clarity. |
...
- Define Notification Service in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Notification Service"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Notification Service"]
...
| --- | --- |
| Problem first | Explain what problem Notification Service solves before naming tools or patterns. |
...
| Scenario | How Notification Service Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Notification Service solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Notification Service to an interviewer in 90 seconds.
