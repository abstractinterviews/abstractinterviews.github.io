...
| --- | --- |
| Core idea | Interview Prep helps candidates discuss communication clarity, evaluation signal, trade-off reasoning, and round strategy with clarity. |
...
- Define Interview Prep in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Interview Prep"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Interview Prep"]
...
| --- | --- |
| Problem first | Explain what problem Interview Prep solves before naming tools or patterns. |
...
| Scenario | How Interview Prep Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Interview Prep solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Interview Prep to an interviewer in 90 seconds.
