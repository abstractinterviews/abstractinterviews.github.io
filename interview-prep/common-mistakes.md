...
| --- | --- |
| Core idea | Common Mistakes to Avoid helps candidates discuss communication clarity, evaluation signal, trade-off reasoning, and round strategy with clarity. |
...
- Define Common Mistakes to Avoid in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Common Mistakes to Avoid"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Common Mistakes to Avoid"]
...
| --- | --- |
| Problem first | Explain what problem Common Mistakes to Avoid solves before naming tools or patterns. |
...
| Scenario | How Common Mistakes to Avoid Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Common Mistakes to Avoid solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Common Mistakes to Avoid to an interviewer in 90 seconds.
