...
| --- | --- |
| Core idea | Glossary helps candidates discuss interview readiness, conceptual clarity, trade-offs, and practical application with clarity. |
...
- Define Glossary in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Glossary"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Glossary"]
...
| --- | --- |
| Problem first | Explain what problem Glossary solves before naming tools or patterns. |
...
| Scenario | How Glossary Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Glossary solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Glossary to an interviewer in 90 seconds.
