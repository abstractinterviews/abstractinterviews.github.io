...
| --- | --- |
| What is it? | Event Sourcing is a design pattern topic used to make a specific engineering decision explicit. |
...
Event Sourcing exists because real systems need a reusable way to manage load, coupling, correctness, latency, or change.
...
```mermaid
flowchart LR
    Smell["Design pressure"] --> Pattern["Apply Event Sourcing"]
