...
| --- | --- |
| What is it? | CQRS is a design pattern topic used to make a specific engineering decision explicit. |
...
CQRS exists because real systems need a reusable way to manage load, coupling, correctness, latency, or change.
...
```mermaid
flowchart LR
    Smell["Design pressure"] --> Pattern["Apply CQRS"]
