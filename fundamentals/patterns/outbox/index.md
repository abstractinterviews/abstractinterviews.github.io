...
| --- | --- |
| Core idea | Outbox Pattern helps candidates discuss interview readiness, conceptual clarity, trade-offs, and practical application with clarity. |
...
- Define Outbox Pattern in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Outbox Pattern"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Outbox Pattern"]
...
| --- | --- |
| Problem first | Explain what problem Outbox Pattern solves before naming tools or patterns. |
...
| Scenario | How Outbox Pattern Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Outbox Pattern solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Outbox Pattern to an interviewer in 90 seconds.
