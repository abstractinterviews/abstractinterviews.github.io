...
| --- | --- |
| Core idea | Reverse Proxy helps candidates discuss architectural trade-offs, scalability, reliability, maintainability, and organizational impact with clarity. |
...
- Define Reverse Proxy in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Reverse Proxy"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Reverse Proxy"]
...
| --- | --- |
| Problem first | Explain what problem Reverse Proxy solves before naming tools or patterns. |
...
| Scenario | How Reverse Proxy Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Reverse Proxy solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Reverse Proxy to an interviewer in 90 seconds.
