...
| --- | --- |
| Core idea | CDN (Content Delivery Network) helps candidates discuss architectural trade-offs, scalability, reliability, maintainability, and organizational impact with clarity. |
...
- Define CDN (Content Delivery Network) in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define CDN (Content Delivery Network)"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["CDN (Content Delivery Network)"]
...
| --- | --- |
| Problem first | Explain what problem CDN (Content Delivery Network) solves before naming tools or patterns. |
...
| Scenario | How CDN (Content Delivery Network) Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does CDN (Content Delivery Network) solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain CDN (Content Delivery Network) to an interviewer in 90 seconds.
