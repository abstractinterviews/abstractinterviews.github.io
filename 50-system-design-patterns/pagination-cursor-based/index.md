...
| --- | --- |
| Core idea | Pagination (Cursor-Based) helps candidates discuss architectural trade-offs, scalability, reliability, maintainability, and organizational impact with clarity. |
...
- Define Pagination (Cursor-Based) in one or two crisp sentences before expanding.
...
~~~mermaid
flowchart LR
    A["Clarify the prompt"] --> B["Define Pagination (Cursor-Based)"]
...
~~~mermaid
flowchart TD
    Problem["Problem or requirement"] --> Concept["Pagination (Cursor-Based)"]
...
| --- | --- |
| Problem first | Explain what problem Pagination (Cursor-Based) solves before naming tools or patterns. |
...
| Scenario | How Pagination (Cursor-Based) Shows Up |
| --- | --- |
...
| Front | Back |
| --- | --- |
| What problem does Pagination (Cursor-Based) solve? | It helps structure a decision around requirements, constraints, trade-offs, and production impact. |
...
1. Explain Pagination (Cursor-Based) to an interviewer in 90 seconds.
