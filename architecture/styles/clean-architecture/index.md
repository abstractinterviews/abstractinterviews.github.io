...
| --- | --- |
| Core idea | Clean Architecture is an architecture concept candidates use to reason about boundaries, trade-offs, evolution, and production readiness. |
...
~~~mermaid
flowchart LR
    A["Requirements"] --> B["Architecture choice: Clean Architecture"]
    B --> C["Benefits"]
    B --> D["Trade-offs"]
    B --> E["Failure modes"]
    C --> F["Recommendation"]
...
| --- | --- |
| Define | "Clean Architecture is useful when..." |
...
| Front | Back |
| --- | --- |
| What makes Clean Architecture architectural? | It affects hard-to-change decisions such as boundaries, ownership, data flow, and deployment. |
...
1. Explain Clean Architecture in 90 seconds using a real product example.
