...
stats:
  ...
  - value: "Senior"
    label: "Level"
overview: "Monoliths, services, and layered domain boundaries."
key_takeaways:
...
subtopics:
  - title: "Monolith"
    description: "Interview-ready guide to Monolith, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/monolith/"
    icon: "A"
    color: "blue"
  - title: "Layered"
    description: "Interview-ready guide to Layered, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/layered/"
    icon: "A"
    color: "blue"
  - title: "Modular Monolith"
    description: "Interview-ready guide to Modular Monolith, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/modular-monolith/"
    icon: "A"
    color: "blue"
  - title: "Microservices"
    description: "Interview-ready guide to Microservices, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/microservices/"
    icon: "A"
    color: "blue"
  - title: "SOA"
    description: "Interview-ready guide to SOA, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/soa/"
    icon: "A"
    color: "blue"
  - title: "Event Driven"
    description: "Interview-ready guide to Event Driven, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/event-driven/"
    icon: "A"
    color: "blue"
  - title: "Serverless"
    description: "Interview-ready guide to Serverless, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/serverless/"
    icon: "A"
    color: "blue"
  - title: "Hexagonal"
    description: "Interview-ready guide to Hexagonal, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/hexagonal/"
    icon: "A"
    color: "blue"
  - title: "Clean Architecture"
    description: "Interview-ready guide to Clean Architecture, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/clean-architecture/"
    icon: "A"
    color: "blue"
  - title: "Onion Architecture"
    description: "Interview-ready guide to Onion Architecture, including trade-offs, diagrams, migration notes, and production concerns."
    read_time: "7 min read"
    url: "/architecture/styles/onion-architecture/"
    icon: "A"
    color: "blue"
related_concepts:
...
| --- | --- |
| [Monolith]({{ '/architecture/styles/monolith/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Layered]({{ '/architecture/styles/layered/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Modular Monolith]({{ '/architecture/styles/modular-monolith/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Microservices]({{ '/architecture/styles/microservices/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [SOA]({{ '/architecture/styles/soa/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Event Driven]({{ '/architecture/styles/event-driven/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Serverless]({{ '/architecture/styles/serverless/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Hexagonal]({{ '/architecture/styles/hexagonal/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Clean Architecture]({{ '/architecture/styles/clean-architecture/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
| [Onion Architecture]({{ '/architecture/styles/onion-architecture/' | relative_url }}) | Use this to answer design, migration, and production trade-off questions. |
...
| --- | --- |
| What is it? | Architecture Styles is a architecture style topic used to make a specific engineering decision explicit. |
...
Architecture Styles exists to help teams make structural decisions that remain understandable as the system, organization, and traffic grow.
...
```mermaid
flowchart LR
    Drivers["Business and quality drivers"] --> Decision["Architecture Styles decision"]
...
> [!IMPORTANT]
> Production reality: the interview answer should mention what happens when assumptions break. For Architecture Styles, discuss hot paths, observability, limits, backpressure, and how teams detect and recover from failures.
...
Interviewers are testing whether you can connect Architecture Styles to constraints, tradeoffs, and failure modes. A strong answer starts simple, states assumptions, chooses the right abstraction, and then explains what would change at larger scale.

### Interview Questions

1. What problem does Architecture Styles solve better than the simpler alternative?
...
5. What would make you reject Architecture Styles?
...
- Architecture Styles is useful only when its core tradeoff matches the prompt.
...
1. Define Architecture Styles in one sentence.
...
Use Architecture Styles when it directly improves the dominant constraint: lookup speed, coupling, scalability, reliability, delivery speed, or reasoning clarity.

### Why Not Use It

Avoid Architecture Styles when the simpler approach already meets the requirements, when operational overhead exceeds the benefit, or when the team cannot own the added complexity.

### Migration Strategy

1. Start with the simplest working design and capture baseline metrics.
2. Introduce Architecture Styles behind a narrow interface or compatibility layer.
...
Architecture Styles changes how teams communicate. It may require clearer ownership, better contracts, shared vocabulary, and explicit review of cross-team dependencies.
...
- Architecture Styles solves a specific pressure; name that pressure first.
...
**Common interview answer:** "I would use Architecture Styles when the constraints make its tradeoff worthwhile. I would start with the simplest version, validate the bottleneck, then add this structure or pattern where it improves the hot path while keeping failure modes observable."
...
1. **Q:** What is the main purpose of Architecture Styles? **A:** To solve a specific constraint or reasoning problem more clearly than a naive approach.
