...
| --- | --- |
| Core idea | Migration Patterns is an architecture concept candidates use to reason about boundaries, trade-offs, evolution, and production readiness. |
...
~~~mermaid
flowchart LR
    A["Requirements"] --> B["Architecture choice: Migration Patterns"]
    B --> C["Benefits"]
    B --> D["Trade-offs"]
    B --> E["Failure modes"]
    C --> F["Recommendation"]
...
| --- | --- |
| Define | "Migration Patterns is useful when..." |
...
| Front | Back |
| --- | --- |
| What makes Migration Patterns architectural? | It affects hard-to-change decisions such as boundaries, ownership, data flow, and deployment. |
...
1. Explain Migration Patterns in 90 seconds using a real product example.
